...
export const config = {
  ...
  // Queued chats can be claimed by the bot in a bounded durable worker so they remain
  // visible as QUEUED but do not block the 1s discovery loop. Supervised stays manual.
  lcAutoClaimQueued: bool(process.env.LIVECHAT_AUTO_CLAIM_QUEUED, true),
